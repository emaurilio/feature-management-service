...
@Processor('audit-ux-research')
@Injectable()
export class AuditUXResearchProcessor extends WorkerHost {
  private readonly logger = new Logger(AuditUXResearchProcessor.name);

  constructor(
    private readonly elasticsearchService: ElasticsearchService,
    @InjectQueue('deadletter-ux-research') private readonly deadletterQueue: Queue,
