...
describe('UXResearchResponseRepository - searchByUXResearchIdPaginated', () => {
  ...
  it('should return paginated UX research responses when found', async () => {
    ...
    const result = await repository.searchByUXResearchIdPaginated(uxResearchId, page, limit);
  ...
  it('should return empty paginated result when no responses found', async () => {
    jest.clearAllMocks();
  ...
  it('should handle database errors gracefully', async () => {
    ...
    await expect(repository.searchByUXResearchIdPaginated(uxResearchId, page, limit))
