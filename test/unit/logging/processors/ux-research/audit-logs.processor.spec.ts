...
import { AuditUXResearchProcessor } from 'src/modules/ux-research/processors/audit-logs.processor';
...
describe('AuditUXResearchProcessor (ux-research)', () => {
  let processor: AuditUXResearchProcessor;
  ...
  beforeEach(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        ...
        {
          provide: getQueueToken('deadletter-ux-research'),
    ...
    processor = module.get<AuditUXResearchProcessor>(AuditUXResearchProcessor);
    elasticsearchService = module.get(ElasticsearchService);
    deadletterQueue = module.get(getQueueToken('deadletter-ux-research'));
  ...
  describe('sendToElastic (via process)', () => {
    it('should index with correct structure including processedAt', async () => {
      ...
      expect(call.index).toBe('audit-ux-research');
